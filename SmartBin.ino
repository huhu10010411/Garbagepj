...
#define SRF05_DETECT_PERSON_TRIG_PIN    5
#define SRF05_DETECT_PERSON_ECHO_PIN    4
...
#define ACCESS_TOKEN                           "ymsa4ja8MDz75C4Fu4P8"                       
...
// WiFi
#define WIFI_SSID       "HUNG"     // Change this to your WiFi SSID
#define WIFI_PASSWORD    "0332560144"
...
bool readSRF05_Detect_Person() {
  ...
  if (millis() - previous_millis >= 100) {
    ...
    if(distance == 0)
    Serial.println("Detect people sensor fail");
...
void loop()
{
  ...
  if (millis() - autoSendtoServer >= 30000) {
  ...
  switch(modeRun)
  {
    ...
    case CLOSE_STATE:
       myservo.write(ANGLE_CLOSE);
       Serial.println("close trash bin");
       delay(500);
       modeRun = IDLE_STATE;
      break;
  }
